use utf8;
package Nectar::Schema::NECTAR_DEVEL::Result::V2Ensembl;
...
Nectar::Schema::NECTAR_DEVEL::Result::V2Ensembl
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AmTw+F8rT0Wis+SAQAvdBQ
