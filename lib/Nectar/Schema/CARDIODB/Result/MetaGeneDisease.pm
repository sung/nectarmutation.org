use utf8;
package Nectar::Schema::CARDIODB::Result::MetaGeneDisease;
...
Nectar::Schema::CARDIODB::Result::MetaGeneDisease
...
=head1 TABLE: C<MetaGeneDiseases>

=cut

__PACKAGE__->table("MetaGeneDiseases");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:261nn1F5pQYdkIQrBs9J4g
