use utf8;
package Nectar::Schema::CARDIODB::Result::Cgvar;
...
Nectar::Schema::CARDIODB::Result::Cgvar
...
=head1 TABLE: C<CGvars>

=cut

__PACKAGE__->table("CGvars");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oYcCaM9DoSadX70jigzI0g
