use utf8;
package Nectar::Schema::CARDIODB::Result::Gatk;
...
Nectar::Schema::CARDIODB::Result::Gatk
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:9KmLgrbOxWxeHel1j/qP+w
